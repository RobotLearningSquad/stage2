...
{
	int         ret                  = MSP_SUCCESS;
	const char* login_params         = "appid = 5adde103, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
	/*
	* rdn:           合成音频数字发音方式
	* volume:        合成音频的音量
	* pitch:         合成音频的音调
	...
	*/
	...
	const char* filename             = "timeInfo.wav"; //合成的语音文件名称
	const char* text                 = "主人，早上好。现在是北京时间2018年5月11日11:12:06"; //合成文本
	/* 用户登录 */
